...
//    curl -X POST -F "files=@/Users/kimdong-uk/Downloads/files/sample/img1.jpeg" -F "files=@/Users/kimdong-uk/Downloads/files/sample/img2.jpeg" -F "pname=Product1" -F "sale=true" -F "price=12000" -F "writer=user1" http://localhost:8080/api/products
    @PostMapping("")
